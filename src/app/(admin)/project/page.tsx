export default function ProjectPage() {
    return (
        <main className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-4 pb-16 sm:pb-20 md:pb-24">
                <div className="bg-primary-elevated rounded-lg p-6 sm:p-8">
                    ...
                    <p className="text-text-primary text-2xl font-semibold">24</p>
                </div>
                <div className="bg-primary-elevated rounded-lg p-6 sm:p-8">
                    <p className="text-sm sm:text-base font-medium leading-2xl text-text-placeholder mb-2">
                        Pending Reviews
                    </p>
                    <p className="text-text-primary text-2xl font-semibold">6</p>
                </div>
            </section>
        </main>
    );
